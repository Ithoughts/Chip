...
- (id)initWithFrame:(CGRect)frame appSession:(SampleApplicationSession *) app
{
    ...
    if (self) {
        ...
        for (int i = 0; i < NUM_AUGMENTATION_TEXTURES; ++i) {
            augmentationTexture[i] = [[Texture alloc] initWithImageFile:[NSString stringWithCString:textureFilenames[i]
...
- (void)renderFrameQCAR
{
    ...
    /***** Constructing the MVP matrix,code that builds the MVP matrix from the trackable Pose (for each trackable). *****/
