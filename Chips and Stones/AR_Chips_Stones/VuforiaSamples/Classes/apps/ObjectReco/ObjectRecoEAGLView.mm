...
#import <QCAR/ObjectTarget.h>
#import <QCAR/ObjectTargetResult.h>
...
- (void)renderFrameQCAR
{
    ...
    for (int i = 0; i < state.getNumTrackableResults(); ++i) {
        ...
        if (! result->isOfType(QCAR::ObjectTargetResult::getClassType())) {
            continue;
        }
        
        NSLog(@"@>@ ObjectTarget found!");
        
        const QCAR::ObjectTarget& objectTarget = (const QCAR::ObjectTarget&) trackable;
        
        QCAR::Vec3F objectSize = objectTarget.getSize();
