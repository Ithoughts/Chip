...
#pragma mark - SampleApplicationSession
...
#pragma mark - Initialize the Vuforia SDK
...
- (void)initQCARInBackground
{
    ...
    @autoreleasepool {
        QCAR::setInitParameters(mQCARInitFlags,"6486c5241df8470eaa5c1cc8176b671b");
...
-(void) showCameraAccessWarning
{
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"iOS8 Camera Access Warning"
                                                    message:message
                                                   delegate:self
